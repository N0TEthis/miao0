...
![Снимок архивного документа](https://via.placeholder.com/800x400.png?text=Пример+архивного+документа+на+сайте)
...
![Интерфейс поиска по каталогам](https://via.placeholder.com/800x300.png?text=Интерфейс+сквозного+поиска+по+архивным+фондам)
